...
def solve_kernel(K, y, lambd, q=1, *, K_eig=None, alpha_init=None,
    ...
    def record(checked_value=None):
        nonlocal best_state, best_score, stale, reason
        # Only the immediately preceding descent check may supply a value
        # for this exact accepted state. Other routes evaluate normally.
        value = objective() if checked_value is None else checked_value
