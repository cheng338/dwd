...
See [the fitted-state contract](../failed_refit_state.md).
...
See [the intercept explanation](../intercept_midpoint_refinement.md),
[anchor recovery equations](../anchor_linear_system.md),
[change history](../../CHANGES.md), and the preserved
[1.3.4 performance release](RELEASE_NOTES-1.3.4.md).
